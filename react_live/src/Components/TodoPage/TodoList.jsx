        ...
        <>
            <div className="flex align-v-center">
                <div className="relative">
                    <input className="pointer def_check" checked={props.todoListObj.isDone ? true : false} type="checkbox" onChange={() => props.markRead(props.todoListObj)} />
                    <div className="check"></div>
                </div>
                <div className="task_name">{props.todoListObj.listName}</div>
            </div>
            <div className="flex right_icons">
                <div className="flex pointer edit_icon" onClick={() => props.editItems(props.todoListObj)}>
                ...
                <div className="remove_item flex pointer" onClick={() => props.removeItems(props.todoListObj.id)}>
